...
#|
(with-open-file (*standard-output* "dice.svg" :direction :output :if-exists :supersede)
...
#|
(with-open-file (*standard-output* "tile.svg" :direction :output :if-exists :supersede)
...
#|
(with-open-file (*standard-output* "board.svg" :direction :output :if-exists :supersede)
...
(defun web-handle-computer ()
  ...
  (tag script ()
       (princ
	 "window.setTimeout('window.location=\"game.html?chosen=NIL\"' ,2000);")))
