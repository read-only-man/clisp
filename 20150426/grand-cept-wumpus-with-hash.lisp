...
(defparameter *congetsion-city-edges* nil)
...
(defun direct-edges (node edge-list)
  (remove-if-not (lambda (x)
		   (eql (car x) node))
		 edge-list))
;(print (direct-edges (random-node) (make-edge-list)))
...
(print (time (dotimes (i 100) (get-connected-hash 1 (hash-edges (make-edge-list))))))
;(print (sort (get-connected (random-node) (make-edge-list)) #'<))
